...
const Switch = ({ value, setValue, className }: SwitchProps) => (
  <SwitchPrimitive.Root
    ...
    id="airplane-mode"
  >
    <SwitchPrimitive.Thumb className="shadow-2xl block w-4 h-4 bg-brand-primary rounded-full transition-transform duration-100 translate-x-0.5 will-change-transform data-[state=checked]:translate-x-[22px]" />
  </SwitchPrimitive.Root>
);
