...
const ModalContent = ({ children }: { children: ReactNode }) => (
  <div className="z-30 px-7 mt-6 mb-4">{children}</div>
);
    ...
    <div className="relative z-0">
      <DialogPrimitives.Root open={isOpen}>
        <DialogPrimitives.Portal>
          ...
          />
          <DialogPrimitives.Content className="pt-7 z-20 data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[500px] translate-x-[-50%] translate-y-[-50%] rounded-lg  shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none bg-brand-navy-light">
